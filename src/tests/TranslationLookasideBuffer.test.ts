...
describe("Test TLB", () => {
    ...
    const virtualAddress1: VirtualAddress = VirtualAddress.fromInteger(0x00001000);
    ...
    const virtualAddress2: VirtualAddress = VirtualAddress.fromInteger(0x00002000);
    ...
    const virtualAddress3: VirtualAddress = VirtualAddress.fromInteger(0x00003000);
    ...
    test("Get entry", () => {
        translationLookasideBuffer.get(VirtualAddress.fromInteger(0x00001000));
        expect(translationLookasideBuffer.data).toEqual([
    ...
    test("Get entry", () => {
        translationLookasideBuffer.get(VirtualAddress.fromInteger(0x00001000));
        expect(translationLookasideBuffer.data).toEqual([
            [3, [VirtualAddress.fromInteger(0x00001000).getMostSignificantBits(20), pageTableEntry1]], 
            [1, [VirtualAddress.fromInteger(0x00002000).getMostSignificantBits(20), pageTableEntry2]]
        ]);
    });
    ...
    test("Get entry", () => {
        ...
        expect(translationLookasideBuffer.data).toEqual([
            ...
            [1, [VirtualAddress.fromInteger(0x00003000).getMostSignificantBits(20), pageTableEntry3]]
        ]);
    });
});
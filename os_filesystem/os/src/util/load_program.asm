...
.UTIL_LOAD_PROGRAM:
    ...
    ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;; prepare stack to load uninitialized data segment ;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
    ; get uninitialized data segment size
    MOV $PROGRAM_HEADER, %eax
    ADD $44, %eax ; PH offset
    MOV *%eax, %eax 
    CMP $0, %eax
    JE _UTIL_LOAD_PROGRAM_UNINITIALIZED_DATA_SEGMENT_SKIP

    ; get virtual address start of uninitialized data segment
    MOV $PROGRAM_HEADER, %ebx
    ADD $40, %ebx ; PH offset
    MOV *%ebx, %ebx ; get v-address
    ...
    ; ebx = v-address
    ; ecx counter
    ._UTIL_LOAD_PROGRAM_UNINITIALIZED_DATA_SEGMENT_LOOP_START:

    CMP %eax, %ecx
    JGE _UTIL_LOAD_PROGRAM_LOAD_UNINITIALIZED_DATA_SEGMENT_SUCCESS
    ADD $4, %ecx
    MOV $0, *%ebx
    ADD $4, %ebx
    JMP _UTIL_LOAD_PROGRAM_UNINITIALIZED_DATA_SEGMENT_LOOP_START

    ._UTIL_LOAD_PROGRAM_LOAD_UNINITIALIZED_DATA_SEGMENT_SUCCESS:



    ._UTIL_LOAD_PROGRAM_UNINITIALIZED_DATA_SEGMENT_SKIP:

...
._UTIL_INITIALIZE_PAGE_DIRECTORY_TABLE_L2_START:
    ...
    ADD $8, %edx
    CMP $832, *%edx
    JGE _UTIL_INITIALIZE_PAGE_DIRECTORY_TABLE_KERNEL_BLOCK_FLAGS_L2
    OR $0xB0000000, %eax ; B = Present, Executable, Mode bits set
    JMP _UTIL_INITIALIZE_PAGE_DIRECTORY_TABLE_L2_FLAGS_DONE

    ._UTIL_INITIALIZE_PAGE_DIRECTORY_TABLE_KERNEL_BLOCK_FLAGS_L2:
    OR $0x90000000, %eax ; 9 = Present and Mode bits set


._UTIL_INITIALIZE_PAGE_DIRECTORY_TABLE_L2_FLAGS_DONE:
